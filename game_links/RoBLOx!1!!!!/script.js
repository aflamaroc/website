window.onload = async () => {
  ...
  const hacked_statements = ["Yes", "Maybe", "Most Likely", "Highly Probable", "Potentially", "Unlikely But Still Possible", "Almost Certainly", "Definitely", "Absolutely", "gOOtEm"];
  ...
  try {
    ...
    video.oncanplaythrough = async () => {
      ...
      if (my_ip && ip_data) {
        push("Haha", "Gottem");
        push("Stop playing roblox", "and stop asking, ur never gonna get it");
